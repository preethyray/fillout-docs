...
<Frame style={{ width: '373px', height: '320px' }}>
...
Use [this approach](/choose-record-to-update) if you prefer to let users choose (in Fillout) which record they’d like to update.
...
<Frame style={{ width: '303px', height: '319px' }}>
...
<Frame style={{ width: '576px', height: '339px' }}>
