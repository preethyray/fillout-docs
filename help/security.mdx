...
This Security Practices page describes the administrative, technical and physical controls applicable to Fillout. If you have additional questions regarding security, please contact [security@fillout.com](/help/) and we will respond as soon as possible.
...
See our [privacy policy](/help/privacy-policy).
...
You can email [security@fillout.com](/help/) with details on any security vulnerabilities you discover. Fillout operates a security bug bounty program. Security researchers around the world continuously test the security of the Fillout services, and report issues via the program.
