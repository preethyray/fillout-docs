...
- **Next** **<Icon icon="arrow-right"/>** - assigned button for form, review, payment, login, and scheduling [pages](/help/page-types)
- **Submit** - button to proceed to the [ending page](/help/ending-page)
- **Back** **<Icon icon="arrow-left"/>** - located on the upper left corner, allows respondents to view previous pages
...
<Frame>
<img src="/images/5.webp" alt="Edit button labels" />
</Frame>
...
<Frame>
<img src="/images/6.webp" alt="Customize button design and animation" />
</Frame>
...
<Frame>
<img src="/images/7.webp" alt="Change back button's position" />
</Frame>
...
<Frame>
<img src="/images/8.webp" alt="Add a skip button" />
</Frame>
