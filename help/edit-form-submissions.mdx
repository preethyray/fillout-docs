...
<CardGroup cols={3}>
  <Card title="Update existing Airtable records with a form" href="/help/airtable-update-form" icon="table-layout" iconType="regular" color="#FFC738">
  Make a form that edits existing records from Airtable and pre-fills fields with data from the record.
  </Card>
  <Card title="Update existing Notion pages with a form" href="/help/notion-update-form" icon="book" iconType="regular" color="#FFC738">
