...
<CardGroup cols={3}>
  <Card title="Connect Fillout to hundreds of other apps with Zapier" icon="bolt" iconType="regular" color="#FFC738" href="/help/zapier">
    Add automations to your form.
  </Card>
  <Card title="Populate dropdowns options with a webhook" icon="list-dropdown" iconType="regular" color="#FFC738" href="/help/dynamic-form-dropdowns">
