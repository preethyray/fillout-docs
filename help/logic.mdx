...
<CardGroup cols={2}>
  ...
  <Card title="Conditionally hide fields" icon="eye-slash" iconType="regular" color="#FFC738" href="/help/conditional-hiding">
  ...
  <Card title="Form validation" icon="square-check" iconType="regular" color="#FFC738" href="/help/input-validation">
