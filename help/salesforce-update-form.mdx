...
<Frame>
  <img src="/images/Screenshot2025-02-12at5.22.38PM.png" alt="Screenshot of the Integrate tab of a form" />
</Frame>

Then, click `Update record`.

<Frame>
  <img src="/images/sfra.png" alt="Screenshot of the Integrate tab of a form" />
</Frame>
...
<Frame>
  <img src="/images/sfra2.png" alt="Screenshot of the Integrate tab of a form" />
</Frame>

Go to your Salesforce dashboard and click the `settings icon` on the upper right side followed by `Open Advanced Setup`.

<Frame>
  <img src="/images/sfra3.png" alt="Screenshot of the Integrate tab of a form" />
</Frame>

Using **Quick Find** on the left-panel, search for `Object Manager`. Click your `object`. In our example, we used Contact.

<Frame>
  <img src="/images/ScreenShot2024-04-15at3.42.34PM.png" alt="Screenshot of the Integrate tab of a form" />
</Frame>

Go to `Fields & Relationships` and create a `New` field.

<Frame>
  <img src="/images/Screenshot2025-02-12at5.38.18PM.png" alt="Screenshot of the Integrate tab of a form" />
</Frame>
