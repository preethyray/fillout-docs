...
You can limit the access given to any user in your Fillout organization. [Invite](/help/invite-collaborators) them to have `Limited Access`.

<Frame>
  <img src="/images/account/image-11.png" alt="Manage team members with granular permissions" />
</Frame>
...
<Note>
Granular permissions are available on the **Enterprise** plan. [Learn more here](https://www.fillout.com/enterprise).
</Note>
...
<Frame>
  <img src="/images/account/image-12.png" alt="View existing permissions" />
</Frame>
...
<Frame>
  <img src="/images/account/image-13.png" alt="Limit access to integrations (connected accounts)" />
</Frame>

By default, [integrations](/help) are accessible to all workspaces. To limit access to a connected account, hover over an integration and click `All`.

<Frame>
  <img src="/images/account/image-14.png" alt="Limit access to integrations (connected accounts)" />
</Frame>

Next, select `Limited workspaces` and choose the workspaces that you would like to share the integration connection with.

<Frame>
  <img src="/images/account/image-15.png" alt="Limit access to integrations (connected accounts)" />
</Frame>
...
If you need granular permissions for Zapier/Make, we instead recommend using the per-form [webhook integration](/help/webhook) to trigger external automations.
