...
By default, [integrations](/help/integrations) are accessible to all workspaces. To limit access to a connected account, hover over an integration and click `All`.
