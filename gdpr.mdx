...
<Note>
  **Note:** Fillout offers EU-based hosting and storage for all respondent data (form submissions) on our [Enterprise plan](https://www.fillout.com/enterprise). [Contact us](https://main.fillout.com/enterprise) to learn more and to obtain a Data Processing Agreement (DPA).
</Note>
...
For more information about Fillout’s security and data storage policies, check our [Fillout Security docs](/security).
...
Every Fillout form includes a CSV spreadsheet export of your form data. Open your Fillout form, click Results, then click the Download arrow button to [save a spreadsheet export](/view-responses) of your form responses.
...
<CardGroup cols={3}>
  <Card title="Subprocessors" icon="panel-ews" iconType="regular" color="#FFC738" href="/subprocessors">
