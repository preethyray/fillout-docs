...
<Note>
  **Note:** Only the **account owner** can delete their own account and they have to downgrade first if they're on a paid plan.
</Note>
...
<Check>
  **Important:** If you need to just change the email you use, head over to [account settings](/account).
</Check>
...
<CardGroup cols={3}>
  <Card title="Reset your password" icon="unlock-keyhole" iconType="regular" color="#FFC738" href="/reset-password">
    Change your password for security reasons or regain access to your account.
  </Card>
