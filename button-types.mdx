...
The **Background color** of your button is determined by the [**Primary**](/themes) color you choose in your **Theme**. You can change its color through the right-hand panel.
...
<Frame style={{ width: '240px' , height: '474px' }}>
...
<Note>
  **Note:** Custom themes are available on the **Starter** plan and above. Learn more about our pricing plans and advanced features [**here**](https://www.fillout.com/pricing).
</Note>
...
<Frame style={{ width: '624px' , height: '206px' }}>
