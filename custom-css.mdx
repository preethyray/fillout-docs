...
<Frame style={{ width: '528px' , height: '256px' }}>
  ![](/images/advanced/image-14.png)
</Frame>

<Note>
  **Note:** Custom CSS is available starting on the **Pro** plan. For more details on pricing, click [**here**](https://www.fillout.com/pricing).
</Note>
...
<Frame style={{ width: '528px' , height: '351px' }}>
  ![](/images/advanced/image-16.png)
</Frame>
