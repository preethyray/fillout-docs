...
<Frame>
  ![Screenshot of the Form designer tab of a form](/images/image-14.png)
</Frame>

You can edit the button label in the right-hand panel by clicking the `settings` icon.

<Note>
  **Note:** The Fill again button is only available on [ending pages](/ending-page).
</Note>
...
<Frame style={{ width: '288px', height: '225px' }}>
  ![Screenshot of the Form designer tab of a form](/images/image-15.png)
</Frame>
