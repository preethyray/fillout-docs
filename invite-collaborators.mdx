...
<Frame style={{ width: '288px' , height: '63px' }}>
...
<Frame style={{ width: '528px' , height: '260px' }}>
...
<Frame style={{ width: '672px' , height: '199px' }}>
...
<Frame style={{ width: '432px' , height: '351px' }}>
...
<CardGroup cols={3}>
  <Card title="Import and export forms" href="/importing-and-exporting-forms" icon="folder-open" iconType="regular" color="#FFC738">
