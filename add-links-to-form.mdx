...
<Frame style={{ width: '336px' , height: '95px' }}>
  ![](/images/advanced/image-33.png)
</Frame>

Your link will appear blue and underlined, which will open in a new tab when clicked.

<Frame style={{ width: '624px' , height: '341px' }}>
  ![](/images/advanced/image-34.png)
</Frame>
