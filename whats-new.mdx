...
<Update label="November 2024">
  ...
  Choose who can approve each submission and define custom approval states.
...
<Update label="August 2024">
  ...
  Fillout now natively integrates with Pipedrive. Create deals, people and organizations from your forms and schedulers.
  ...
  Create a custom Google Doc for each Fillout form submission.
...
<Update label="August 2024">
  ...
  Introducing Fillout Workflows: the easiest way to automate your forms & scheduling.
...
<Update label="July 2024">
  ...
  Calculate the [time span](https://www.fillout.com/help/sharing) between two dates. Use the result in conditional logic, answer piping or anywhere in your form.

  ![12 Pn](/images/12.png)

  #### ⚡️ Trello and Tag Manager integrations

  Fillout now integrates natively with Trello (by Atlassian) and Google Tag Manager.
