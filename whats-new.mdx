...
<Update label="April 2025" className="whats-new-container">
  ...
  Fillout now integrates natively with [ClickUp](/help/clickup).
  <Frame>
    ![4 Pn](/images/4.png)
  </Frame>
...
<Update label="March 2025">
  ...
  Collect multiple rows of data with the new [table field](/help/table). Let respondents specify how many items they want to add.
  <Frame>
  ...
  **Note:** The table field can be connected to webhooks, Zapier and Make (native integrations coming soon\!).
  ...
  Delete form responses with the new [REST API endpoint](/help/fillout-rest-api#561f294d7c17464e9b53fa1ca78c9ecf).
  ...
  Add [fields to a PDF](/help/pdfs) only if they meet a certain condition.
...
<Update label="January 2025" description>
  ...
  Book meetings with [one host and many invitees](/help/group-meeting). Best for webinars, courses and group events.
  <Frame>
...
<Update label="November 2024">
  ...
  Send SMS messages in Fillout Workflows with the new [Twilio](/help/twilio) integration. ![Screenshot2025 04 23at4 01 30PM Pn](/images/Screenshot2025-04-23at4.01.30PM.png)
  ...
  Fillout workflows now support [branching](/help/filter-branch-workflows) and conditional logic.
  <Frame>
...
<Update label="November 2024">
  ...
  Choose who can approve each submission and define custom [approval](/help/approval-workflows) states.
  <Frame>
    #### ![K Pn](/images/k.png)
  </Frame>
...
<Update label="August 2024">
  ...
  Include uploaded files or [generated PDF documents](/help/pdfs) in your notification emails. Optionally cc or bcc recipients.

  [Create an email workflow](/help/custom-emails) to get started.
  <Frame>
    ![F Pn](/images/f.png)
  </Frame>
  #### 💼 Pipedrive integration

  Fillout now natively integrates with [Pipedrive](/help/pipedrive). Create deals, people and organizations from your forms and schedulers.
  <Frame>
    ![G Pn](/images/g.png)
  </Frame>
  ...
  Create a custom [Google Doc ](/help/google-docs)for each Fillout form submission.
...
<Update label="August 2024">
  ...
  Introducing [**Fillout Workflows**](/help/workflows): the easiest way to automate your forms & scheduling.
...
<Update label="August 2024">
  ...
  Require form respondents to login via Google SSO to further protect your forms. Learn more about form login pages [here](/help/login-page).
  <Frame>
    ![1111 Pn](/images/1111.png)
  </Frame>
  If you'd like to learn more about security at Fillout, you can do so [here](/help/security) or email [security@fillout.com](mailto:security@fillout.com) anytime with questions.
</Update>
...
<Update label="July 2024">
  ...
  Calculate the [time span](/help/calculations#b7d8c8a8aa254e4e972c3966ff3cb6df) between two dates. Use the result in conditional logic, answer piping or anywhere in your form.
  <Frame>
    ![12 Pn](/images/12.png)
  </Frame>
  #### ⚡️ Trello and Tag Manager integrations

  Fillout now integrates natively with [Trello](/help/trello) (by Atlassian) and [Google Tag Manager](/help/google-tag-manager).
...
<Update label="June 2024">
  ...
  See what each [embed type](/help/sharing) will look like and test different settings.
...
<Update label="June 2024">
  ...
  Fillout now has a brand new [Stripe integration](/help/payment-page).
...
<Update label="May 2024">
  ...
  [PDF generation](/help/pdfs) in Fillout now supports text formatting.
  ...
  Sync file uploads to an Amazon S3 bucket with Fillout's [new integration](/help/amazon-s3).

  #### 🏠 Control granular permissions from the members page

  [Configure access](/help/granular-permissions) for all Fillout workspaces from the admin settings page.
  <Frame>
  ...
  Create a form that [updates](/help/salesforce-update-form) existing Salesforce records. Optionally connect to a sandbox environment before going live.
...
<Update label="April 2024">
  ...
  Fillout's [PDF generation](/help/pdfs) feature now automatically maps fields from your form, using AI. Click the ✨ icon to test it out.
  ...
  The native [Salesforce](/help/salesforce) integration is now available to all Enterprise customers. We're continuing to deepen the integration - let us know if you have any feature requests\!
  <Frame>
  ...
  Fillout now integrates natively with [Linear](/help/linear), the leading project management tool for startups.
...
<Update label="March 2024">
  ...
  Allow respondents to upload files to [Google Drive](/help/google-drive) or [Microsoft OneDrive](/help/microsoft-onedrive) with your Fillout forms.
  ...
  Fillout's [PDF integration](/help/pdfs) now supports displaying multiple choice fields as plaintext, instead of checkboxes. We've also fixed a lot edge cases with more complex documents.

  #### ⬅️ Set back button position

  In your advanced theme settings, set the [back button](/help/button-types) to appear near the next button, instead of the top left corner.
  <Frame>
  ...
  If you use Slack instead, take a look at our existing [Slack integration](/help/slack).
  <Frame>
...
<Update label="February 2024">
  ...
  To get started, add a [voice recording field](/help/voice-recording) to your form.
...
<Update label="February 2024">
  ...
  The Fillout [REST API](/help/fillout-rest-api) lets you access your form responses programmatically, without using the Fillout site.
  ...
  [Relay](/help/relay-app) is our new favorite tool for human-in-the-loop and AI-assisted automations.
...
<Update label="February 2024">
  ...
  [Subforms](/help/subforms) make it easy to collect repeated information in your forms.
  ...
  This field lets respondents [select from previous submissions](/help/submission-picker) of any Fillout form, without the need for a 3rd party integration.
...
<Update label="February 2024">
  ...
  Today's theme is Login 2.0. Adding the upgraded [login page](/help/login-page) to your form is more than just a way to verify email addresses. It also streamlines a lot of data intake workflows - more details below\!
  ...
  Add Microsoft, OneLogin, Google Workspaces, Okta and other types of SSO login to your form. Optionally pre-fill fields with custom SSO attributes. Learn more [here](/help/sso-form-login).
