...
Head to **Integrate** and connect your form to [Airtable](/airtable), [Notion](/notion), [HubSpot](/hubspot), or [other databases](/integrations).
...
You can create a field, [pre-fill](/prefill-fields) it with a value, and connect it to Airtable or Notion through the **Connected** menu in the right-hand panel.
...
<Frame style={{ width: '624px', height: '244px' }}>
